...
const socialLinks = {
  ...
  facebook: "https://www.facebook.com/people/Circulo-Musical-de-Sevilla/61581075881201/",
  whatsapp: "https://wa.me/34691196341",
} as const;

function InstagramIcon(props: Readonly<SVGProps<SVGSVGElement>>) {
  return (
...
function FacebookIcon(props: Readonly<SVGProps<SVGSVGElement>>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden {...props}>
...
function WhatsAppIcon(props: Readonly<SVGProps<SVGSVGElement>>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden {...props}>
            ...
            <ul className="mt-4 flex list-none flex-wrap gap-3">
              <li>
                <Link
                  ...
                  aria-label="Instagram: @circulomusicaldesevilla"
                >
              ...
              <li>
                <Link
                  ...
                  rel="noopener noreferrer"
                  className={socialButtonClass}
                  aria-label="Facebook: Círculo Musical de Sevilla"
                >
